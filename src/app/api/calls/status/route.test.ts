...
describe('GET /api/calls/status', () => {
  ...
  it('reports note progress so a note phase that goes dark is visible', async () => {
    getSupabaseServiceClientMock.mockReturnValue(
      fakeSupabase({
        noteRows: [
          { ghl_note_posted_at: '2026-08-29T10:00:00.000Z', ghl_note_skip_reason: null, ghl_note_quarantined_at: null, ghl_note_last_failure_code: null },
          { ghl_note_posted_at: '2026-08-29T12:00:00.000Z', ghl_note_skip_reason: null, ghl_note_quarantined_at: null, ghl_note_last_failure_code: null },
          { ghl_note_posted_at: null, ghl_note_skip_reason: null, ghl_note_quarantined_at: null, ghl_note_last_failure_code: null },
          { ghl_note_posted_at: null, ghl_note_skip_reason: 'is_test', ghl_note_quarantined_at: null, ghl_note_last_failure_code: null },
          { ghl_note_posted_at: null, ghl_note_skip_reason: null, ghl_note_quarantined_at: '2026-08-29T13:00:00.000Z', ghl_note_last_failure_code: 'highlevel_post_failed' },
        ],
      }),
    );
