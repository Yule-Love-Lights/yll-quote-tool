...
const TABS: { id: string; label: string }[] = [
  ...
  // The quotes dev/testing tools (test quotes + delete) moved to their own
  // sub-category page: /settings/quotes (SettingsSubNav → "Quotes"), #93.
];
...
// The Quotes dev/testing tools (test quotes + delete) now live on their own
// sub-category page — src/app/settings/quotes/page.tsx + the QuotesSettings
// component (#93). They were a tab here; promoted to a SettingsSubNav entry.
