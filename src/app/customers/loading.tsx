...
// active="customers", so this skeleton mirrors that instead of replacing it.
// The wrapper div matches the real page's own content div (max-w-6xl mx-auto
// w-full, no extra padding) — OperatorShell already supplies py-8 px-4.
