// Shared placeholder rows for the /admin/jobs list (row 332, mirrors
...
// client-side GET /api/jobs call is in flight). Previously the page's
...
// /admin/jobs/[id]'s own client-fetch loading state, since that detail route
// has no loading.tsx of its own and inherits this one during a route
