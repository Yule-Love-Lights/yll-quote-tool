// Portal v2 DARK — What Happens Next, PERMANENT variant (#88). Same 4-step
// timeline layout/styling as WhatHappensNext, but the final step is year-round
// control instead of a seasonal takedown (permanent lighting stays up for good).

import { CheckCircle2, MessageSquare, Truck, Smartphone } from 'lucide-react';
...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: 'Aluminum track under the eave — no mess, no roof damage, done in a day.',
  },
  {
    icon: Smartphone,
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="max-w-2xl mb-12 md:mb-16">
          ...
          >
            Four steps to year-round color.
          </h2>
        </div>
