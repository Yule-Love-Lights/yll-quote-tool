...
// we'll reach out for the deposit. When online payment lands (#38), this becomes
// "deposit received" off the payment-confirmed signal.
...
export function BookedBanner({ quoteId, approvedAt }: BookedBannerProps) {
    ...
    <div className="sticky top-0 z-50 w-full bg-[#0D1519]/95 backdrop-blur border-b border-[#FFB744]/30">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-center">
        ...
        <p className="text-[13px] md:text-[14px] text-[#F4ECD8]">
          You&apos;re booked{dateLabel ? ` — approved ${dateLabel}` : ''}. We&apos;ll reach out to
          collect your 50% deposit.
        </p>
        <Link
