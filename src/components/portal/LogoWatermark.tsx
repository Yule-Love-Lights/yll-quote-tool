...
//
// Placement (#45): TOP-RIGHT on all sizes (Naldo S4 — was desktop top-left).
...
export function LogoWatermark({ className = '' }: Props) {
  return (
    ...
    <img
      ...
      draggable={false}
      className={
        // Top-right on all sizes (Naldo S4 — dropped the desktop top-left override).
      ...
      style={{ opacity: 0.4, filter: 'drop-shadow(0 1px 2px rgba(0,0,0,0.4))' }}
    />
  );
}
