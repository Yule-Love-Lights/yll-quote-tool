...
- **⛳ OPEN — Naldo to provide:** the actual **warranty terms** ("lifetime warranty on materials" — what it covers materials-vs-labor, duration, transferability, what voids it). P6 shows the agreed terms at/near the approve+deposit step and stores the **terms version** the customer approved with the approval snapshot. Blocks the P6 RiskReversal copy.
