...
- [Session log — Jason](session_log.md) — Jason's per-session continuity thread; newest entry on top. *(Latest ~3 sessions only; S12-and-older in [session_log_archive.md](session_log_archive.md), S16.)*
