...
- [Integration DATA CONTRACT (v0.2, LOCKED)](project_integration_data_contract.md) — the keystone spec for #27: scene storage in Supabase + the line-item ⇄ scene-item linkage (two projection rules, roofline tier enum, surface tags, included flags). Build-ready — Phase 1 starts from it. Read before building #27.
