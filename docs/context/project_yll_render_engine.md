...
---
> **⚰️ HISTORICAL (2026-06-12): this entire pipeline was REMOVED in task #36 (S7)** — code (`src/lib/rendering/*`, routes, admin pages), the `renders` table + bucket, and the Gemini/Replicate env vars are all gone. The portal visual is the live Konva design (#27/#35). Keep this doc only as the record of what was built and why; do NOT use it to guide new work.
